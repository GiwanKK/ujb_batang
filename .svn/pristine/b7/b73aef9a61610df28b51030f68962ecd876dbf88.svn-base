...
function fn_changeTag(data){
	...
	$(".selc_list li").on("click", function(){
		...
		console.log("this.children[0] : " ,this.children[0].text)
		var param = {
		...
		console.log("param[toString(this.children[0].className)] : " ,param[this.children[0].className])
		console.log("document.getElementsByClassName(param[this.children[0].className]).length : " ,document.getElementsByClassName(param[this.children[0].className]).length)
