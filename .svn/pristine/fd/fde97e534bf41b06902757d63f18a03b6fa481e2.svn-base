package kr.go.uijeongbu.cmm.service.impl;
...
import kr.go.uijeongbu.cmm.service.ComFileMngService;
...
public class ComFileMngServiceImpl extends EgovAbstractServiceImpl implements ComFileMngService {
	 ...
	 */
	public String insertFileInf(kr.go.uijeongbu.cmm.vo.FileVO fvo) throws IOException, SQLException {
