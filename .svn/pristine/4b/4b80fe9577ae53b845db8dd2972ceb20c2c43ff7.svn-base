package kr.go.uijeongbu.manager.inDataMng.dataStatusMng.web;
...
import kr.go.uijeongbu.cmm.util.FrequentlyUtil;
import kr.go.uijeongbu.cmm.vo.LoginVO;
import kr.go.uijeongbu.manager.inDataMng.dataStatusMng.service.DataStatusMngService;
...
private static final Logger LOGGER = LoggerFactory.getLogger(DataStatusMngController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/inDataMng/dataStatusInit.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/inDataMng/dataStatusSearch.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
