 ...
 * </pre>
 */
package kr.go.uijeongbu.common.web;
...
import kr.go.uijeongbu.common.service.CommonService;
...
public class CommonController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/checkRoleMenuCnt.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	public ModelAndView checkRoleMenuCnt(@RequestBody Map<String, Object> params, HttpServletRequest request, ModelMap model) throws SQLException, Exception {
		...
		Map<String, Object> menuInfo = CommonUtil.convertMapToJson(params, "menuInfo");
		// 메뉴 권한 체크
		Map<String, Object> chkMenuInfo = commonService.checkRoleMenuCnt(menuInfo);
