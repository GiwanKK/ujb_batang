...
$(function () {
    ...
    ****************************************************************************************************/
	...
	function fn_getRoleList() {
		...
		var requestUrl = "/mamager/userAuth/getAuthList.do";
	...
	function fn_getMenuList(paramRoleInfo) {
		...
		var requestUrl = "/mamager/userAuth/selectAuthMenuList.do";
    ...
    ****************************************************************************************************/
		...
		currForm.validate(validationItems, function(returnValidData, validSuccess){
			...
			if(validSuccess){
		    	...
		    	if(Util.isEmpty(roleInfo.roleCode)){
		    		...
		    		var requestUrl = "/mamager/userAuth/insertAuthList.do";
		    		...
		    		var requestUrl = "/mamager/userAuth/updateAuthList.do";
	...
	$("#btnSaveRoleMenu").on("click", function(){
		...
		if(selectedMenuList.length <= 0){
			...
			var requestUrl = "/mamager/userAuth/updateAuthMenuList.do";
