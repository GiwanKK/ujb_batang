...
$(function () {
    ...
    ****************************************************************************************************/
	...
	function fn_loadWord(){
		...
		Util.request("/mamager/userAuth/selectAuthUserInfo.do", param, function(resultData){
	...
	function fn_getSolutionUserList() {
		...
		var requestUrl = "/mamager/userAuth/selectAuthUserList.do";
    ...
    ****************************************************************************************************/
	...
	$("#btnCreateRole").on("click", function(){
    	...
    	if(userInfo.length > 0){
    		...
    		var requestUrl = "/mamager/userAuth/userAuthSolutionInsert.do";
	...
	$("#btnSaveRoleMenu").on("click", function(){
    	...
    	if(userInfo.length > 0){
    		param = userInfo[0];
	    	var requestUrl = "/mamager/userAuth/userAuthSolutionDelete.do";
