...
var Util = {
	...
	requestAjax : function(param, returnAjaxCallBack){
		$.ajax({
			...
			type : "POST",
			timeout : 3000000,								// 요청 제한 시간. 제한 시간 안에 요청이 완료되지 않으면 요청을 취소하거나 error 콜백을 호출.
			cache : false,
			global : true,
						...
						if(!bDupFlag){
							...
							switch(ruleOption.toUpperCase()){
								...
								case "REQUIRED":
					        		...
					        		if(Util.isEmpty(objCheckValue)){ validateMsg = DEF.messages.required.format(checkTitle)};
					        		break;
