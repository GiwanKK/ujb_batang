	...
	<section id="container">
			...
			<div class="admin_content">
				...
				<div class="right_area">
					...
					<div class="tab_area">
						<ul class="tab_all">
							<li class="tab_link on" data-tab="tab-1">세부 정보</li>
							<li class="tab_link"  data-tab="tab-2">데이터 이력</li>
						</ul>
					</div>
...
<%-- 
	...
	<!-- Page 스크립트 -->
	<script src="${pageContext.request.contextPath}/pageJs/manager/outDataMng/outDataMng.js"></script>
