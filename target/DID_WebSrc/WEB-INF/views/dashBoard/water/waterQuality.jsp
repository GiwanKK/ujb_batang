						...
						<div class="col1 coline_t po_rel">
							...
							<div class="water_quality">
                            	<dl id="sort1" class="wq_box">
									<!-- <dt>와부정수장<br><span class="tiny_12 c_gray">측정일시 : <span id=""></span>2021. 04. 04. 11:00</span></dt>
									<dd><img src="/dist/images/water/ico_water_good.svg" alt="" /><br><span class="wq_stitle">잔류염소 (7.1658)</span></dd>
									<dd><img src="/dist/images/water/ico_water_bad.svg" alt="" /><br><span class="wq_stitle">Ph (1.146)</span></dd>
									<dd><img src="/dist/images/water/ico_water_good.svg" alt="" /><br><span class="wq_stitle">탁도 (0.0421)</span></dd> -->
								</dl>
								<dl id="sort2" class="wq_box bt0">
									<!-- <dt>덕소정수장<br><span class="tiny_12 c_gray">측정일시 : 2021. 04. 04. 11:00</span></dt>
									<dd><img src="/dist/images/water/ico_water_bad.svg" alt="" /><br><span class="wq_stitle">잔류염소 (7.1658)</span></dd>
									<dd><img src="/dist/images/water/ico_water_good.svg" alt="" /><br><span class="wq_stitle">Ph (1.146)</span></dd>
									<dd><img src="/dist/images/water/ico_water_good.svg" alt="" /><br><span class="wq_stitle">탁도 (0.0421)</span></dd> -->
								</dl>
                            </div>
						</div>
