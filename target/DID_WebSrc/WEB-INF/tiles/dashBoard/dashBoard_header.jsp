...
%>
        ...
        <div id="header">
			<h1>
			<dd>
				<a href="javascript:;"  menucode="MENU_00002" linkurl="/dashBoard/main.do" ><img src="${pageContext.request.contextPath}/dist/images/logo_top.png" alt="logo"> <span class="logo_text">의정부시의 모든것</span></a></h1>
			</dd>
			<div class="top_right">
				...
				<div class="menu_top">
					...
					<div id="menu">
						...
						<div class="gnb_all">
							...
							<dl class="gnb_02">
								<dt>여론 및 민원 분석</dt>
								<dd><a href="javascript:;" menucode="MENU_00023" linkurl="/dashBoard/complain/complainStatus.do">시정뉴스</a></dd>
