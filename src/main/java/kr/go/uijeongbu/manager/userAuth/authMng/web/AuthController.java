 ...
 */
package kr.go.uijeongbu.manager.userAuth.authMng.web;
...
import kr.go.uijeongbu.manager.userAuth.authMng.service.AuthService;
...
public class AuthController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/authMng.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/getAuthList.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/insertAuthList.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/updateAuthList.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/deleteAuthList.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/selectAuthMenuList.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/updateAuthMenuList.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
