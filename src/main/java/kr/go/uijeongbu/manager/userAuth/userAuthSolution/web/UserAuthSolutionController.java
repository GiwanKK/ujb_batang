package kr.go.uijeongbu.manager.userAuth.userAuthSolution.web;
...
import kr.go.uijeongbu.manager.userAuth.userAuthSolution.service.UserAuthSolutionService;
...
private static final Logger LOGGER = LoggerFactory.getLogger(UserAuthSolutionController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/userAuthSolutionInsert.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/userAuthSolutionDelete.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/selectAuthUserInfo.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/mamager/userAuth/selectAuthUserList.do", method = RequestMethod.POST, produces={"application/json; charset=UTF-8"})
