...
public class ComplainStatusController {
	...
	public ModelAndView complainStatusData(HttpServletRequest request, @RequestBody Map<String, Object> params) throws SQLException, Exception {
		...
		List<Map<String, Object>> complainNews = complainStatusService.getMaxNewsList();
		//max-1 뉴스 데이터
		if( params.get("option") != null && params.get("option").equals("Week")) {
			List<Map<String, Object>> complainNews1 = complainStatusService.getMaxNewsList1(params);
			modelAndView.addObject("complainNews1", complainNews1);
		}else if( params.get("option") != null && params.get("option").equals("Month")) {
			List<Map<String, Object>> complainNews2 = complainStatusService.getMaxNewsList2(params);
			modelAndView.addObject("complainNews2", complainNews2);
		}else {
			List<Map<String, Object>> complainNews1 = complainStatusService.getMaxNewsList1(params);
			List<Map<String, Object>> complainNews2 = complainStatusService.getMaxNewsList2(params);
			modelAndView.addObject("complainNews1", complainNews1);
