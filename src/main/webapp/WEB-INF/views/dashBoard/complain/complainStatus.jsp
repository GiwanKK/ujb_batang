...
<%
  /**
  * @Class Name : complainStatus.jsp
  * @Description : 대시보드 - 민원실 현황 페이지
...
<div id="container">
	...
	<div class="content_wrap">
				<div class="content">
					...
					<!-- <div class="col3_2 coline_r pd0">
						<div class="col1">
							<div class="s_minwon01">
								<h3 class="did_title">
									<span id="spnYear">2021</span>년 <span id="spnMonth">4</span>월 민원 대기 현황
									<p class="bt_xs b_gray57"><a id="btnSummaryData">누적 현황</a></p>
									<p class="bt_xs b_gray57"><a id="btnLiveData">실시간 5분 대기 현황</a><span id="dateTxt" ></span></p>
								</h3>
								<div class="apply_all">
									
									<div class="apply_box">
										<p class="minwon_title c_green">여권 민원실</p>
										<dl class="apply_num">
											<dt>여권신청</dt>
											<dd><span class="dd_txt">누적 민원 수</span> <span id="spnText1" class="dd_num c_green"></span></dd>
										</dl>
										<dl class="apply_num">
											<dt>여권발급</dt>
											<dd><span class="dd_txt">누적 민원 수</span> <span id="spnText2" class="dd_num c_green"></span></dd>
										</dl>
									</div>
									
									<div class="apply_box">
										<p class="minwon_title c_aquab">시청 민원실</p>
										<dl class="apply_num">
											<dt>일반민원</dt>
											<dd><span class="dd_txt">누적 민원 수</span> <span id="spnText3" class="dd_num c_aquab">123</span></dd>
										</dl>
										<dl class="apply_num">
											<dt>가족관계등록</dt>
											<dd><span class="dd_txt">누적 민원 수</span> <span id="spnText4" class="dd_num c_aquab">1</span></dd>
										</dl>
									</div>
						...
						<div class="col1 coline_t">
							<div class="s_minwon02">
								<h3 class="did_title">각 동 주민센터 일반
 현황</h3>
								<div id="statusData" class="dong_apply_all">
									
									<div class="dong_unit">
										<ul class="unit_con">
											<li class="pic_dong"><img src="image/minwon/41150510.png" alt="의정부1동지도" /></li>
											<li class="dong_name">의정부 1동 <span class="klein">누적민원 수</span></li>
											<li class="sum_up">99</li>
										</ul>
									</div>
									...
									<div class="dong_unit">
										<ul class="unit_con">
											<li class="pic_dong"><img src="image/minwon/uijeongbu1.png" alt="의정부1동지도" /></li>
											<li class="dong_name">의정부 1동 <span class="klein">누적민원 수</span></li>
											<li class="sum_up">99</li>
										</ul>
									</div>
					...
					<div class="col3">
						<div class="s_minwon03">
							<h3 class="did_title" id="did_title"></h3>
							<div class="news_wrap">
								<div  class="news_list_all">
									<ul id="newsList" class="list_news" style="padding-bottom:40px">
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col3">
						<div class="s_minwon03">
							<h3 class="did_title" id="did_title_1"></h3>
							<div class="news_wrap">
								<div id="newsList_1" class="news_list_all">
									<ul id = "weekNews" class="list_news" style="padding-bottom:40px">
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col3">
						<div class="s_minwon03">
							<h3 class="did_title" id="did_title_2"></h3>
							<div class="news_wrap">
								<div id="newsList_2" class="news_list_all">
									<ul id = "monthNews" class="list_news" style="padding-bottom:40px">
									</ul>
								</div>
							</div>
						</div>
...
<input type ="hidden" id = "moreCntWeek" value = 0>
<input type ="hidden" id = "moreCntMonth" value = 0>
<!-- js 라이브러리 -->
<!-- Date Time Picker   --> 
...
<script src="${pageContext.request.contextPath}/dist/js/common/etc/loading/ajax-loading.js"></script>
    ...
    <%-- <script src="${pageContext.request.contextPath}/pageJs/dashBoard/complain/complainStatus.js"></script> --%>
    <script src="${pageContext.request.contextPath}/pageJs/dashBoard/complain/complainNews.js"></script>
