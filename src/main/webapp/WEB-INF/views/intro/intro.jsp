...
<!-- 				<li><a href="javascript:;" class="btn_intro intro_blue" onClick="fn_goIntro('MENU_00001');"><span>의정부시 빅데이터</span>활용 시스템</a></li> -->
				<li><a href="javascript:;" class="btn_intro intro_green" onClick="fn_goIntro('MENU_00002');"><span>의정부시 빅데이터</span>DID 시스템</a></li>
				<li class="menu_admin"><a href="javascript:;" class="btn_intro intro_yellow" onClick="fn_goIntro('MENU_00050');"><span>의정부시 빅데이터</span>관리자페이지</a></li>
			</ul>
...
<script type="text/javascript">
	...
	$(function(){
		...
		if ( (navigator.appName == 'Netscape' && agent.indexOf('trident') != -1) || (agent.indexOf("msie") != -1)) {
			window.location = 'microsoft-edge:'+nowUrl;
		}else{
			console.log("Not IE!!")
		}
	})
				...
				if(!Util.isEmpty(menuLinkUrl)){
					console.log(document.getElementById('frmIntro'))
				     ...
				     if( paramMenuCode == 'MENU_00001' ){
				    	...
				    	// document.getElementById('frmIntro').action = "http://localhost:8075/webGis/visualList.do";
				     }else{
